...
3.  **Come to our office hours**. We have 90 minutes reserved for AQM questions on Tuesdays 15:30 to 17:00. Here is a link for [Dom's](https://calendly.com/undzenas-qm/aqm-dom) and [Muhammad's](https://calendly.com/muhammad-muhammad-uni-mannheim/aqm-muh-office-hours) office hours. To avoid waiting, please schedule an appointment via Calendly 5 hours in advance. If you already have specific questions you want to ask, include them already so that we can plan and prepare for your questions ahead of time. If Tuesday does not work for you at all, contact me on slack and we can make an appointment.
...
-   Things that help me (this might be different for you):
    ...
    -   Taking time off to do things that are not related to work.
...
R Markdown integrates really well with R Code. You can include a new code chunk by pressing *Ctrl+Alt+I*. In a code chunk you can write and evaluate all your favorite R Code and include the results directly in your document. For example a plot.
...
See the [R Markdown Reference Guide](https://yihui.org/knitr/options/) for a complete list of knitr chunk options.
...
When functions get long and complicated it can be helpful to write multiple, simple functions and then call them inside of a master function. Also, it is really important and helpful to comment every operation that your function fulfils for future references. (It may be obvious what we are doing now. But someone else or even future me might have a hard time figuring out every line of code.)
...
**Matrix algebra will be essential in this course!** There will be matrix algebra in every single week. So if you struggle understanding these operations, please review the respective material from your maths course this week.
